...
class iPhoneXXS11Pro1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xff814e4e),
      body: Stack(
        children: <Widget>[
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 356.0, 18.0),
                    size: Size(356.0, 18.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child:
                      ...
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(331.7, 3.3, 24.3, 11.3),
                          size: Size(356.0, 18.0),
                          pinRight: true,
                          fixedWidth: true,
                          fixedHeight: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(311.3, 3.3, 15.3, 11.0),
                          size: Size(356.0, 18.0),
                          pinRight: true,
                          pinTop: true,
                          pinBottom: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(289.3, 3.7, 17.0, 10.7),
                          size: Size(356.0, 18.0),
                          pinRight: true,
                          pinTop: true,
                          pinBottom: true,
          ...
          Transform.translate(
            offset: Offset(326.0, 33.0),
            child:
                // Adobe XD layer: 'navbar mobile dark' (group)
                SizedBox(
              width: 29.0,
              height: 28.0,
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 29.0, 28.0),
                    size: Size(29.0, 28.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(3.0, 8.1, 23.4, 12.0),
                    size: Size(29.0, 28.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
          ...
          Transform.translate(
            offset: Offset(47.0, 262.0),
            child: Container(
              width: 285.0,
              height: 500.0,
              decoration: BoxDecoration(
                color: const Color(0xff403939),
